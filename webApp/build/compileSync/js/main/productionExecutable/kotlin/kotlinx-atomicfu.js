(function (factory) {
  ...
  protoOf(AtomicRef).ch = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicRef).dh = function () {
  ...
  protoOf(AtomicBoolean).eh = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicBoolean).dh = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicInt).fh = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicInt).dh = function () {
    return this.kotlinx$atomicfu$value;
  };
